...
load_from = 'work_dirs/posec3d_fall_binary/epoch_23.pth'
log_level = 'INFO'
...
optim_wrapper = dict(
    ...
    optimizer=dict(
        lr=0.2, momentum=0.9, nesterov=True, type='SGD', weight_decay=0.0003),
    type='OptimWrapper')
param_scheduler = [
    dict(
        T_max=24,
...
test_evaluator = [
    dict(
        ...
        type='AccMetric'),
    dict(
        out_file_path='work_dirs/posec3d_fall_binary/epoch_23_pred.pkl',
        type='DumpResults'),
]
test_pipeline = [
    dict(
